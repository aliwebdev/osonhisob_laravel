...
<div class="card-body">
              <h5 class="card-title">O'tkazmani Tahrirlash</h5>
              ...
              <form action="{{ route('accounts.update',['account' => $account->id]) }}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="kimga" name="kimga" value="{{$account->kimga}}" class="form-control" placeholder="Qabul qiluchi shaxsning firmasi">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="hisob_raqam" class="col-sm-2 col-form-label">Hisob Raqami</label>
                  <div class="col-sm-10">
                    <input type="number" id="hisob_raqam" name="hisob_raqam" value="{{$account->hisob_raqam}}" class="form-control" placeholder="Qabul qiluchi shaxsning hisob raqami">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="kimdan" class="col-sm-2 col-form-label">Kimdan otkazilgan</label>
                  <div class="col-sm-10">
                    <input type="text" id="kimdan" name="kimdan" value="{{$account->kimdan}}" class="form-control" placeholder="Yuboruvchi shaxsning firmasi">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="pul_miqdori" class="col-sm-2 col-form-label">Pul miqdori</label>
                  <div class="col-sm-10">
                    <input type="number" id="pul_miqdori" value="{{$account->pul_miqdori}}" name="pul_miqdori" class="form-control" placeholder="Qancha miqdorda pul o'tkazilgan">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3" id="usd1" multiple="">
                  ...
                  <div class="col-sm-10">
                   <input type="number" value="{{$account->d_qiymati}}" name="d_qiymati" value="" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">O'tkazilgan Sana</label>
                  <div class="col-sm-10">
                    <input type="date" name="sana" value="{{$account->sana}}" class="form-control">
                  </div>
                </div>
